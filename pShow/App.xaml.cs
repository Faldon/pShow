...
namespace pShow
{
    ...
    public partial class App : Application
    {
        ...
        /// <summary>
        /// Insert a child element in the next cell of a multicolumn grid.
        /// </summary>
        /// <param name="parentElement">
        /// The parent Grid element where children are added.
        /// </param>
        /// <param name="childElement">
        /// A StackPanel element which should be added to the Grid.
        /// </param>
        public static void insertInGrid(Grid parentElement, FrameworkElement childElement)
        {
            // Get the position of the column where the element has to be added
            ...
            if (rowPos > parentElement.RowDefinitions.Count)
            {
                ...
                parentElement.RowDefinitions.Add(row);
            }
            Grid.SetRow(childElement, rowPos);
            Grid.SetColumn(childElement, colPos);
